...
public class TesseractAnalyzer implements Analyzer{
    public TesseractAnalyzer(){
    }

    public String executeOCR() throws IllegalStateException {
        ...
        catch (TesseractException | IOException e)
        {
            ...
            throw new IllegalStateException("Image failed to be read.", e);
        }
    }
